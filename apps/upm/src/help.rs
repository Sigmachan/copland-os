...
pub fn help() {
    printtr!("Usage:");
    printtr!("    upm");
    printtr!("    upm <operation> [...]");
    printtr!("    upm <package(s)>");
    println!();
    printtr!("Copland/EPM operations:");
    printtr!("    upm install|remove|purge <package(s)>");
    printtr!("    upm update|upgrade");
    printtr!("    upm search|info|status <package>");
    printtr!("    upm play <recipe>");
    printtr!("    upm service <action> <unit>");
    printtr!("    upm doctor|toolchain [--json]");
    println!();
    printtr!("Pacman operations:");
    printtr!("    upm {-h --help}");
    printtr!("    upm {-V --version}");
    printtr!("    upm {-D --database}    <options> <package(s)>");
    printtr!("    upm {-F --files}       [options] [package(s)]");
    printtr!("    upm {-Q --query}       [options] [package(s)]");
    printtr!("    upm {-R --remove}      [options] <package(s)>");
    printtr!("    upm {-S --sync}        [options] [package(s)]");
    printtr!("    upm {-T --deptest}     [options] [package(s)]");
    printtr!("    upm {-U --upgrade}     [options] [file(s)]");
    println!();
    printtr!("New operations:");
    printtr!("    upm {-P --show}        [options]");
    printtr!("    upm {-G --getpkgbuild} [package(s)]");
    printtr!("    upm {-B --build}       [dir(s)]");
    println!();
    printtr!("If no arguments are provided 'upm -Syu' will be performed");
    println!();
    ...
    printtr!("    --mode      <mode>     Sets where upm looks for targets");
    printtr!(
